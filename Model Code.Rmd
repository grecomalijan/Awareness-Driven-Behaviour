---
title: "Awareness-Driven Behaviour"
...
```{r Dissertation,+eval=FALSE,error=FALSE,message=FALSE,warning=FALSE,echo=TRUE}
...
k <- runif(10000, Cal.matrix.w[1,2], Cal.matrix.w[1,3])
dcrit <- runif(10000, Cal.matrix.w[2,2], Cal.matrix.w[2,3])
dtotcrit <- runif(10000, Cal.matrix.w[3,2], Cal.matrix.w[3,3])
NPI <-runif(10000, Cal.matrix.w[4,2], Cal.matrix.w[4,3])
